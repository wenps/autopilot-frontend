 ...
 * Adapted from OpenClaw's src/infra/fs-safe.ts
 */
...
/**
 * Open a file that must be within `rootDir`. Rejects symlinks and path-traversal attempts.
 */
export async function openFileWithinRoot(params: {
  ...
  try {
    ...
    if (lstat?.isSymbolicLink()) throw new SafeOpenError("invalid-path", "symlink not allowed");
